    ...
    <form action="/dashbord.php" method="post">
      <div class="form-row">
        ...
        <div class="form-group col-md-4">
          ...
          <input type="tel" class="form-control" name="phone" id="input_telephone" placeholder="Votre telephone"
            required>
        </div>
        <div class="form-group col-md-4">
          <label for="input_naissance">Date</label>
          <input type="date" class="form-control" name="date" id="input_naissance" placeholder="Votre date de naissance"
            required>
        </div>
        <div class="form-group col-md-6">
          <label for="input_mdp">Mot de passe</label>
          <input type="password" class="form-control" name="mdp1" id="input_mdp" placeholder="Votre mot de passe"
            required>
        </div>

        <div class="form-group col-md-6">
          <label for="input_mdp2">Confirmer mot de passe</label>
          <input type="password" class="form-control" name="mdp2" id="input_mdp2" placeholder="Votre mot de passe"
            required>
        </div>
      </div>
      <div class="row">
